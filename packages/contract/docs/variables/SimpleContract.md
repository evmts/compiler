...
Defined in: [contract-lib/SimpleContract.s.sol.ts:51](https://github.com/evmts/compiler/blob/main/packages/contract/src/contract-lib/SimpleContract.s.sol.ts#L51)
