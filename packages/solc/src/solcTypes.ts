...
// This format is valid for Solidity >=0.8 which streamlined the JSON representation and changed a bunch of properties names
...
export type SolcOutput<T extends SolcLanguage = SolcLanguage> = {
	...
	contracts?: {
		[sourceFile: string]: {
			// TODO: type Yul output
			[contractName: string]: T extends 'Yul' ? any : SolcContractOutput
		}
	}
}
...
export interface Solc {
	...
	compile: <T extends SolcLanguage = SolcLanguage>(input: SolcInputDescription<T>) => SolcOutput<T>
