 ...
 * @param {import('../compile/CompileBaseOptions.js').CompileBaseOptions | undefined} options - Constructor options
 * @param {import('../compile/CompileBaseOptions.js').CompileBaseOptions | undefined} overrides - Option overrides
 * @returns {import('../compile/CompileBaseOptions.js').CompileBaseOptions} The merged compilation options
 */
