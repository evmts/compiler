 ...
 * @template {import('@tevm/solc').SolcLanguage} TLanguage
 * @template {import('../compile/CompilationOutputOption.js').CompilationOutputOption[] | undefined} TCompilationOutput
 * @param {object | object[] | string | string[]} source - The source code to validate
 * @param {import('../compile/CompileBaseOptions.js').CompileBaseOptions<TLanguage, TCompilationOutput> | undefined} options - The compilation options
