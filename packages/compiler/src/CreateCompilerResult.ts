...
import type { CompileFilesResult } from './compile/CompileFilesResult.js'
import type { CompileSourceResult } from './compile/CompileSourceResult.js'
import type { CompileSourcesResult } from './compile/CompileSourcesResult.js'
import type { CompileSourceWithShadowOptions } from './compile/CompileSourceWithShadowOptions.js'
...
export interface CreateCompilerResult {
	 ...
	 */
	fetchVerifiedSource: (address: unknown, options: unknown) => Promise<void>
