...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__JsContract_impl_81']?.()
  __napiInstance.exports['__napi_register__JsCompilerConfigOptions_struct_82']?.()
  __napiInstance.exports['__napi_register__JsAstConfigOptions_struct_83']?.()
  __napiInstance.exports['__napi_register__SolcLanguage_84']?.()
  __napiInstance.exports['__napi_register__ProjectPaths_struct_85']?.()
  __napiInstance.exports['__napi_register__JsCompilerSettingsOptions_struct_86']?.()
  __napiInstance.exports['__napi_register__JsOptimizerSettingsOptions_struct_87']?.()
  __napiInstance.exports['__napi_register__JsOptimizerDetailsOptions_struct_88']?.()
  __napiInstance.exports['__napi_register__JsYulDetailsOptions_struct_89']?.()
  __napiInstance.exports['__napi_register__JsDebuggingSettingsOptions_struct_90']?.()
  __napiInstance.exports['__napi_register__JsSettingsMetadataOptions_struct_91']?.()
  __napiInstance.exports['__napi_register__JsModelCheckerSettingsOptions_struct_92']?.()
  __napiInstance.exports['__napi_register__BytecodeHash_93']?.()
  __napiInstance.exports['__napi_register__RevertStrings_94']?.()
  __napiInstance.exports['__napi_register__ModelCheckerEngine_95']?.()
  __napiInstance.exports['__napi_register__ModelCheckerTarget_96']?.()
  __napiInstance.exports['__napi_register__ModelCheckerInvariant_97']?.()
  __napiInstance.exports['__napi_register__ModelCheckerSolver_98']?.()
  __napiInstance.exports['__napi_register__ModelCheckerInvariantKind_99']?.()
  __napiInstance.exports['__napi_register__EvmVersion_100']?.()
}
