...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__JsAst_impl_9']?.()
  __napiInstance.exports['__napi_register__SeverityLevel_10']?.()
  ...
  __napiInstance.exports['__napi_register__JsCompilerLanguage_86']?.()
  __napiInstance.exports['__napi_register__JsLoggingLevel_87']?.()
  __napiInstance.exports['__napi_register__JsVyperOptimizationMode_88']?.()
  __napiInstance.exports['__napi_register__JsVyperCompilerConfig_struct_89']?.()
  __napiInstance.exports['__napi_register__JsAstConfigOptions_struct_90']?.()
  __napiInstance.exports['__napi_register__SolcLanguage_91']?.()
  __napiInstance.exports['__napi_register__JsResolveConflictStrategy_92']?.()
  __napiInstance.exports['__napi_register__ProjectPaths_struct_93']?.()
  __napiInstance.exports['__napi_register__JsCompilerSettingsOptions_struct_94']?.()
  __napiInstance.exports['__napi_register__JsOptimizerSettingsOptions_struct_95']?.()
  __napiInstance.exports['__napi_register__JsOptimizerDetailsOptions_struct_96']?.()
  __napiInstance.exports['__napi_register__JsYulDetailsOptions_struct_97']?.()
  __napiInstance.exports['__napi_register__JsDebuggingSettingsOptions_struct_98']?.()
  __napiInstance.exports['__napi_register__JsSettingsMetadataOptions_struct_99']?.()
  __napiInstance.exports['__napi_register__JsModelCheckerSettingsOptions_struct_100']?.()
  __napiInstance.exports['__napi_register__BytecodeHash_101']?.()
  __napiInstance.exports['__napi_register__RevertStrings_102']?.()
  __napiInstance.exports['__napi_register__ModelCheckerEngine_103']?.()
  __napiInstance.exports['__napi_register__ModelCheckerTarget_104']?.()
  __napiInstance.exports['__napi_register__ModelCheckerInvariant_105']?.()
  __napiInstance.exports['__napi_register__ModelCheckerSolver_106']?.()
  __napiInstance.exports['__napi_register__ModelCheckerInvariantKind_107']?.()
  __napiInstance.exports['__napi_register__EvmVersion_108']?.()
}
